  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10">
          ...
          <a href="login.php?act=byd" class="btn btn-info">รายวัน</a> 
          <a href="login.php?act=bym" class="btn btn-info">รายเดือน</a> 
          <a href="login.php?act=byyear" class="btn btn-success">รายปี</a> 
